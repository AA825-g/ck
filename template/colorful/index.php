...
<?php echo $conf['bottom']?>
  <center>  <div class="panel-body"><span style="font-weight:bold"><?php echo $conf['sitename'] ?> <i class="fa fa-heart text-danger"></i> 2019 | </span><a class="" href="#customerservice" data-toggle="modal"><span style="font-weight:bold">客服与帮助</span></a></center>
</div>
<!--底部导航-->
</div>
<!--音乐代码-->
