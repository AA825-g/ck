...
<div class="panel-body">
  <form action="./uset.php?mod=user_n" method="post" role="form">
	...
	<span class="help-block m-b-none">用于联系与找回密码，网站首页头像显示</span>
	</div>
	...
	<div class="form-group">
	  ...
	  <select class="form-control" name="pay_type" default="<?php echo $userrow['pay_type']?>"><option value="0">支付宝</option><option value="1">微信</option><option value="2">QQ钱包</option></select>
		<span class="help-block m-b-none">你上传的收款图是那种，就选择那种方式</span>
	</div>
	<div class="form-group">
	  <label>提现账号:</label><br/>
...
<div class="panel-body">
  <form action="./uset.php?mod=site_n" method="post" role="form">
	...
	<div class="form-group">
	  <label>首页公告</label><br>
	  <textarea class="form-control" name="anounce" rows="6"><?php echo htmlspecialchars($userrow['anounce']);?></textarea>
	</div>
	<div class="form-group">
	  <label>首页弹出公告</label><br>
	  <textarea class="form-control" name="modal" rows="5"><?php echo htmlspecialchars($userrow['modal']);?></textarea>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
	  ...
	  <textarea class="form-control" name="alert" rows="5"><?php echo htmlspecialchars($userrow['alert']);?></textarea>
	</div>
